...
func (*BatchCommandsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_fa1306cd83dcbcbd, []int{0}
}
...
func (*BatchCommandsRequest_Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_fa1306cd83dcbcbd, []int{0, 0}
}
...
func (*BatchCommandsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_fa1306cd83dcbcbd, []int{1}
}
...
func (*BatchCommandsResponse_Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_fa1306cd83dcbcbd, []int{1, 0}
}
...
func (*BatchRaftMessage) Descriptor() ([]byte, []int) {
	return fileDescriptor_tikvpb_fa1306cd83dcbcbd, []int{2}
}
...
func init() { proto.RegisterFile("tikvpb.proto", fileDescriptor_tikvpb_fa1306cd83dcbcbd) }

var fileDescriptor_tikvpb_fa1306cd83dcbcbd = []byte{
	...
	,
}
